    ...
    return (
        <Select onValueChange={onChangeHandler} defaultValue={value}>
            ...
            <SelectContent>
                ...
                <AlertDialog >
                    <AlertDialogTrigger className='p-medium-14 flex w-full rounded-sm py-3 pl-8 text-primary-50 hover:bg-purple-50 focus:text-primary-500'>Add New Category</AlertDialogTrigger>
